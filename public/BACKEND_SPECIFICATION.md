...
- **`POST /api/chat`**:
  ...
  - **Behavior**: Calls Google Gemini API (`gemini-3.6-flash`) with system prompt enforcement for NECTA curriculum guidelines, bilingual Swahili/English explanation, and markdown rendering.
